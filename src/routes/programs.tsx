    ...
    <main className="min-h-screen bg-course-canvas text-course-ink">
      <section className="course-hero relative overflow-hidden px-4 pb-16 pt-28 sm:px-6 sm:pb-20 sm:pt-36 lg:px-8 lg:pb-24">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-12 h-72 w-72 -translate-x-1/2 object-contain opacity-30 sm:top-8 sm:h-96 sm:w-96 lg:top-2 lg:h-[32rem] lg:w-[32rem]"
          width={900}
          height={900}
          loading="eager"
          decoding="async"
